...
function failure_4()
    ...
    s = MLState(false, CarState[CarState(50.0,3.0,31.22970781020354,0.0,Nullable{BehaviorModel}(),1),CarState(99.24797069990433,4.0,27.167643727404155,0.0,Multilane.IDMMOBILBehavior(Multilane.IDMParam(2.0,2.0,0.8,27.5,4.0,4.0),Multilane.MOBILParam(0.0,4.0,0.2),3),2)])
